...
public class SignOffAdapter extends AbstractAdapter<SignOff> {
	...
	/**
	 * Instantiates a new sign off adapter.
	 *
	 * @param type
	 *            the type
	 * @param mode
	 ...
	 */
	@Override
	public void save(final SignOff entity) {
		this.writer.write(entity.getId(), entity.getChangeSetId(), entity.getIdentityId());
	}
